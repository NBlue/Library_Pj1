...
class BooksController {
    ...
    addNew(req, res) {
        ...
        imgBook.mv(uploadPath, function (err) {
            ...
            var idBook;
            modelBooks.addBook(booksData, function (err, result) {});
            ...
            for (let element of booksData.IdAuthor) {
                if (typeof element === Number) {
                    ...
                    obData.IdAuthor = element;
                    dataWrites.push(obData);
                }
            }
            console.log(dataWrites);
            dataWrites.forEach(function (dataWrite) {
                modelBooks.addWrite(dataWrite, function (err, data) {
