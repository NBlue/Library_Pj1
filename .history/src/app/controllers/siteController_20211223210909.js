...
class SiteController {
    ...
    getBookBorrow(req, res) {
        var context = req.session.context;
        modelBooks.getBookDetail(req.params.id, (err, dataBook) => {
            var author = await modelAuthors.findByIdBook(req.params.id);
            console.log({ "author: ": author });
            res.render("user/user_cart_books", { context, dataBook });
        });
    }
}
