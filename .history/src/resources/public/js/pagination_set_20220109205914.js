...
//         .value.toUpperCase();
//     let List = document.querySelector(".book__list");
//     let Item = document.querySelectorAll(".book__item");
//     let Name = List.querySelectorAll(".book__item-name");

//     if (filterBox.length > 0) {
//         for (let i = 0; i < Name.length; i++) {
//             let name = Name[i].textContent || Name[i].innerHTML;
...
//             for (var element of AdminBook) {
//                 bookItemShow.push(
//                     `<div class="book__item">${element.innerHTML}</div>`
//                 );
//             }
//             $("#pagination").pagination({
//                 dataSource: bookItemShow,
