...
router.get("/search", siteController.getDatasearch);
router.post("/search/:name", siteController.onSearch);
...
// Sách mượn:
router.post("/myBookBorrow/:id", siteController.returnBook);
router.get("/myBookBorrow", siteController.getMyBookBorrow);
